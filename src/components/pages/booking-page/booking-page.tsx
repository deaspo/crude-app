...
import { Dialog, DialogBody, DialogFooter, DialogHeader, DialogModal } from "components/dialog";
import { EditBookingForm, LocationAddForm } from "components/dialog-forms";
import { BookingProps, LocationProps, selectBookingById, useDeleteBookingMutation } from "features";
    ...
    return (
        <div className="min-h-full">
            ...
            <main className="mx-auto max-w-7xl px-8 py-6">
                ...
                <Button
                    type={'button'}
                    buttonClasses="bg-blue-600 hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg"
                    onClick={() => navigate(-1)}
                >
                    Go Back
                </Button>
